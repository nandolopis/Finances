...
public class Cliente implements Serializable{
	...
	//contrutor com argumentos  para facilitar a estanciaçao em uma unica linha, 
	public Cliente(Integer id, String nome, String email, String cpfOuCmpj, TipoCliente tipo, String senha) {
		super();
		this.id = id;
		this.nome = nome;
		this.email = email;
